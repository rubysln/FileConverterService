...
public class ParserHandler extends DefaultHandler {
    ...
    */
    ...
    public void endDocument() throws SAXException {
        ...
        authors.setAuthors(authorList); // Финальный этап работы алгоритма - присваивание значений коллекции авторов в объект Authors, который мы и должны получить.
    }
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        ...
        if(currentTagName == null) return; // Проверка на null
        else{
